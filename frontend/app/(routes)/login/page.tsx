...
const Login = () => {
    ...
    const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        try {
            const res = await LoginApi("/v1/login", payLoad);
            if (res?.status === 200) {
        ...
        <div className="min-h-screen  flex items-center justify-center p-4 sm:p-6 lg:p-8">
            ...
            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
                ...
                <div className="hidden lg:flex flex-col items-center justify-center p-4 lg:p-8">
                    <div className="relative">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <h1 className="text-3xl lg:text-4xl text-white font-bold text-gray-900 dark:text-white mb-3 lg:mb-4">
                                Arvyax Wellness
                            </h1>
                ...
                >
                    ...
                    <h1 className="text-4xl flex items-center justify-center font-extrabold sm:mb-10 mb-4 sm:mt-2 mt-16 text-white text-center"> Login</h1>
                    <div className="max-w-xl lg:max-w-3xl">
                        <form
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                <button
                                    className="flex gap-2 shrink-0 rounded-md  bg-teal-600 px-8 py-3 text-sm font-medium  transition hover:bg-teal-700 text-black focus:outline-none focus:ring "
                                ...
                                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                                    ...
                                    <Link href="/register" className="text-teal-700 underline"> Sign up</Link>.
                                </p>
                            </div>
                        </form>
                    </div>
